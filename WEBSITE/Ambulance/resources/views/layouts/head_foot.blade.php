                                ...
                                <nav class="main-menu style1 navbar-expand-md navbar-light">
                                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                        <ul class="navigation clearfix">
                                            ...
                                            <li><a href="driverlogin">Driver Login</a></li>
                                            <li><a href="tracking ">Track Here</a></li>
            ...
            @endif
                        ...
                        <div class="header-right">
                            <div class="header-social-link">
                                <ul class="clearfix">
                                    <li>
                                        <a href="https://opensource.twitter.dev/"><i class="icon-twitter"></i></a>
                                    </li>
                                    <li>
                                        <a href="https://www.facebook.com/login/"><i class="icon-facebook"></i></a>
                                    </li>
                                    <li>
                                        <a href="https://www.pinterest.com/login/"><i class="icon-pinterest"></i></a>
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com/accounts/login/?hl=en"><i class="icon-instagram"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    ...
                    <div class="social-links">
                        <ul class="clearfix">
                            <li><a href="https://www.facebook.com/login/"><span class="fab fa fa-facebook-square"></span></a></li>
                            <li><a href="https://opensource.twitter.dev/"><span class="fab fa fa-twitter-square"></span></a></li>
                            <li><a href="https://www.pinterest.com/login/"><span class="fab fa fa-pinterest-square"></span></a></li>
                            <li><a href="https://www.youtube.com/"><span class="fab fa fa-google-plus-square"></span></a></li>
                            <li><a href="https://www.youtube.com/"><span class="fab fa fa-youtube-square"></span></a></li>
                        </ul>
                    </div>
                </nav>
            </div>
                        ...
                        <div class="row text-right-rtl">
                                ...
                                <div class="single-footer-widget single-footer-widget--link-box margintop marbtm50">
                                    ...
                                    <div class="footer-widget-links">
                                        <ul>
                                            ...
                                            <li><a href="about">Flight Crews</a></li>
                                            <li><a href="about">Medical Equipment</a></li>
                                            <li><a href="about">Case Manager</a></li>
                                            <li><a href="contact">Contact</a></li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="single-footer-widget margintop">
                                    ...
                                    <div class="footer-widget-links">
                                        <ul>
                                            <li><a href="ambulanceservice">Ambulance Car</a></li>
                                            <li><a href="ambulanceservice">Medical Flight Services</a></li>
                                            <li><a href="ambulanceservice">Medical Escort</a></li>
                                            <li><a href="ambulanceservice">Private Air Ambulance</a></li>
                                            <li><a href="ambulanceservice">Advance Life Support</a></li>
                                            <li><a href="ambulanceservice">General Services</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="footer-bottom">
                    <div class="container">
                        <div class="bottom-inner">
                            <div class="copyright">
                                <p>Copyright &copy; 2022 <a href="index">Ambons</a> All Rights Reserved.</p>
                            </div>
